...
const Header = () => {
  ...
  const handleClick = () => {
    const cartElement = document.querySelector("#offcanvas-add-cart");
  ...
  const handleWish = () => {
    const wishElement = document.querySelector("#offcanvas-wishlish");
    if (!wishElement) return;
    
    if (click) {
      wishElement.style = "transform: translateX(100%);";
    } else {
  ...
  const handleSearch = () => {
    ...
    if (click) {
      searchElement.style = "transform: translate(-100%, 0); opacity: 0";
    } else {
      searchElement.style = "transform: translate(0px, 0px); opacity: 1";
    }
    setClick(!click);
  };
  const handleabout = () => {
    const aboutElement = document.querySelector("#offcanvas-about");
    if (!aboutElement) return;
    
    if (click) {
      aboutElement.style = "transform: translateX(100%);";
    } else {
      aboutElement.style = "transform: translateX(0%);";
    }
    setClick(!click);
  };
  const handlemenu = () => {
    const menuElement = document.querySelector("#mobile-menu-offcanvas");
