export const FaqsData = [
  ...
  },
  {
    ...
    para: `Стандартные сроки доставки составляют 3-7 рабочих дней по Беларуси и 7-14 рабочих дней в другие страны. Для крупных городов доступна экспресс-доставка (1-2 дня). Точные сроки доставки зависят от выбранного способа доставки и вашего региона.`
  },
  {
  ...
  },
  {
    ...
    para: `Минимальная сумма заказа для бесплатной доставки составляет 50 рублей. Для заказов на меньшую сумму стоимость доставки рассчитывается индивидуально в зависимости от веса и габаритов товара, а также выбранного способа доставки.`
  },
  {
    heading: "Скидки",
